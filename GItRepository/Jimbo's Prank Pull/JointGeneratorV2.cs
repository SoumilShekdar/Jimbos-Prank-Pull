...
public class JointGeneratorV2 : MonoBehaviour {
	...
	void Start () {
		...
		spawnedChairs = 0;
		xPosition = 0f;
		upChairPositionBase = new Vector2(0f, 0.42f);
		upNPCPositionBase = new Vector2(0f, 0.70f);
		downChairPositionBase = new Vector2(0f, -0.42f);
		downNPCPositionBase = new Vector2(0f, -0.62f);
